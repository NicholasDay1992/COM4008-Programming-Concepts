...
player = Player((SCREEN_WIDTH/2)-(35/2), (SCREEN_HEIGHT - 100), pygame.image.load("11 PyGame I/defender.png"), 35, 30)

#player_x = 250
#player_img = pygame.image.load("defender.png") #load in the image

invader = Invader(250, 100, pygame.image.load("11 PyGame I/invader1.png"), 30, 30)
invaders = []
...
def draw_invaders():
    for row in range(invader_startrow, invader_endrow, 30): # intervals of 30 
        for col in range(invader_startcol, invader_endcol, 30):
            ...
            inv_obj = Invader(col, row, pygame.image.load("11 PyGame I/invader1.png"), 30, 30)
